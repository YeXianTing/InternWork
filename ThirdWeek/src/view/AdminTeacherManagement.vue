      ...
      <div class="search">
        <el-form :inline="true" ref="form" :model="form">
          <el-form-item label="院系：">
            <el-input v-model="form.department" placeholder="请输入院系" class="input"></el-input>
          </el-form-item>
          <el-form-item label="工号：">
            <el-input v-model="form.jobNumber" placeholder="请输入工号" class="input"></el-input>
          </el-form-item>
          <el-form-item label="姓名：">
            <el-input v-model="form.name" placeholder="请输入姓名" class="input"></el-input>
          </el-form-item>
          <el-form-item>
            <el-button type="success" class="btn1" @click="search">查 询</el-button>
          </el-form-item>
          <el-form-item>
            <el-button type="success" class="btn2" @click="addTeacher">添加教师</el-button>
          </el-form-item>
        </el-form>
      </div>
      <div class="g-table">
        <div class="g-oprater">
          <el-button size="small" class="btn" @click="deleted">
            <img :src="img1" /> 批量删除
          </el-button>
          <el-button size="small" class="btn" @click="imported">
            <img :src="img2" /> 批量导入
          </el-button>
          <el-button size="small" class="btn" @click="downloaded">
            <img :src="img3" /> 下载模板
          </el-button>
        </div>
        <div class="g-information">
          ...
          >
            ...
            <el-table-column prop="code" label="工号" width="110" align="center"></el-table-column>
            ...
            <el-table-column prop="departmentName" label="院系" width="130" align="center"></el-table-column>
...
import { list } from "@/api/schooluser";
export default {
  name: "admin",
  data() {
    return {
  ...
  methods: {
    deleted: function() {
      if (this.$refs.multipleTable.selection == "") {
        ...
        let list = "选中的名单为：";
        this.$refs.multipleTable.selection.forEach(
          x => (list = list + x.name + ".")
        );
        alert(list);
      }
    ...
    search() {
      var model = {};
      model.code = this.form.jobNumber;
      model.department = this.form.department;
      model.realname = this.form.name;
      const pageInfo = {
